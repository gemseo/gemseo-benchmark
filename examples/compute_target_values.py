...
problem.targets_generator.plot_histories(
    best_target_value=problem.optimum, file_path="histories.png"
)
...
problem.target_values.plot(show=False, file_path="target_values.png")
